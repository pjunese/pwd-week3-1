...
const fallbackRestaurants = [
  ...
  },
  {
    ...
    name:"Mr.Chef",
    category: "한식",
    location: "경기 수원시 팔달구 아주로 47번길 16",
    priceRange: "9,000-11,000원",
    rating: 4.75,
    description: "한식 맛집",
    recommendedMenu: ["제육두루치기", "돼지김치찌개"],
    likes: 0,
    image: "/Resimg/img1.png"
  },
  {
  id:5,
  name:"츠츠",
  category: "중식",
  location: "경기 수원시 영통구 광교중앙로37번길 11 지하 1층",
  priceRange: "8000-26000원",
  rating: 4.97,
  description: "탕수육으로 유명한 중화요리 맛집",
  recommendedMenu: ["츠츠해물짬뽕", "츠츠탕수육"],
  likes: 0,
  image: "/Resimg/img2.png"
  }
];

const DEFAULT_BASE_URL = 'https://pwd-week4-pjunese.onrender.com';
